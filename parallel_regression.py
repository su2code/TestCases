...
def main():
    ...
    wedge.test_iter = 100
    wedge.test_vals = [-1.645662, 3.976795, -0.252158, 0.044412] #last 4 columns
    ...
    contadj_ns_cylinder.test_vals = [-3.652061, -9.110103, -2.056700, 4.497000] #last 4 columns
    ...
    contadj_incomp_cylinder.test_vals = [-5.719058, -7.009933, -2.932200, 0.000000] #last 4 columns
    ...
    spinning_cylinder.test_vals = [-7.630431, -2.183233, 1.207712, 1.585353] #last 4 columns
    ...
    edge_VW.test_vals = [-5.727310, -3.271070, -0.000046, 0.000000] #last 4 columns
    ...
    edge_PPR.test_vals = [-6.275569, -3.845865, -0.000056, 0.000000] #last 4 columns
