...
class TestCase:
  ...
  def run_test(self):
    ...
    command = "%s %s > logfile.out" % (self.su2_exec, self.cfg_file)
  ...
  def adjust_iter(self):
    ...
    # Read the cfg file
    self.cfg_file = os.path.join(self.cfg_dir, self.cfg_file)
    ...
    file_out.write('%% This file automatically generated by cruise controlW\n')
